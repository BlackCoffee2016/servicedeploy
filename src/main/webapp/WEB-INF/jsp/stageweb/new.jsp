...
<script src="${pageContext.request.contextPath}/resources/js/stageweb_new.js"></script>
</head>
<body style="font-family: 'Roboto', 'Droid Sans Fallback', '微软雅黑';min-height: 100vh;display: flex;flex-direction: column;">
	...
	<form id="form-new" method="post" action="${pageContext.request.contextPath}/stageweb/insert" style="flex: 1 0 auto;">
						...
						<div class="card-content">
							<span class="card-title black-text">新建项目</span>
								...
								<div class="row">
									...
									<div class="input-field col s6">
										<input type="text" id="input-profile" name="profile" value="test">
										<label for="input-profile">profile</label>
									</div>
									<div class="input-field col s6">
										<input type="text" id="input-contextPath" name="contextPath" value="/">
